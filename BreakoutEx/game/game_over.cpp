...
GLfloat gameOverTextWidth = 0.0f;
...
void GameOver::OnEnter(){
    gameOverTextWidth = Text->GetTextWidth("Game Over", 2.0f);
}
...
{
    Text->RenderText("Game Over", (this->Width-gameOverTextWidth)/2, this->Height / 2.0f-150, 2.0f);
